...
<head>
	<meta charset="UTF-8">
	<title>The Malaytional - About</title>
		...
		<div>
			...
			<div class="body">
				<div id="content">
					<div>
						<div>
							<h4>Why learning from us?</h4>
							<p>
								Why waste your precious time with other recipe blog when you can create an amazing recipes in just minutes?

									Through many years of research, development, and testing, we have created this fantastic recipes. It's reliable and innovative. Our in-house team is constantly provide our users with the latest foods and recipes. Stay tuned for more!

												Plus, our in-house support team is here to help!
							</p>
							<h4>Our history</h4>
							<p>
								The Malaytional.com was started up in 2020 by a group of guys who have a passion in cooking for years, and they are here to share about their passion. Our passsionate delight in our culinary skills, showcasing our expertise and love for cooking by generously and sharing delectable recipes on this dedicated website.
							</p>
							<h4>How can I contact you if I have a complaint and contact response times</h4>
							<p>
								
								You can contact us for any equiries by email at: themalaytional@gmail.com
						</p>
						<p>

								If you having any problem, contact us at: 01-2312311 from 8AM - 8PM
							</p>
